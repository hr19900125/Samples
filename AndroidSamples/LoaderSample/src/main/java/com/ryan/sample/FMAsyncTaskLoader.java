 ...
 */
public abstract class FMAsyncTaskLoader<D> extends Loader<D> {
    ...
    final class LoadTask extends AsyncTask<Void, Void, D> implements Runnable {
        ...
        protected D doInBackground(Void... params) {
            ...
            try {
                D data = FMAsyncTaskLoader.this.onLoadInBackground();
                if (DEBUG) Log.v(TAG, this + "  <<< doInBackground");
                return data;
        ...
        protected void onPostExecute(D data) {
            ...
            try {
                FMAsyncTaskLoader.this.dispatchOnLoadComplete(this, data);
            } finally {
                mDone.countDown();
            }
        }
        ...
        protected void onCancelled(D data) {
            ...
            try {
                FMAsyncTaskLoader.this.dispatchOnCancelled(this, data);
            } finally {
                mDone.countDown();
            }
        }
        ...
        public void run() {
            waiting = false;
            FMAsyncTaskLoader.this.executePendingTask();
        }
    ...
    public FMAsyncTaskLoader(Context context, Executor executor) {
        super(context);
        mExecutor = executor;
    }
