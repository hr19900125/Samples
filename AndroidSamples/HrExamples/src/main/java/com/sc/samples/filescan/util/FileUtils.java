...
public class FileUtils {
    ...
    public static String getSizeFormatText(long length) {
        ...
        if (str.equals("MB") || str.equals("GB") || str.equals("TB")) {
...
//            e.printStackTrace();
     ...
     * @return
     */
    public static boolean isImageFile(String rPath) {
        if (TextUtils.isEmpty(rPath)) {
            return false;
        }
        String mimetype = MimeTypeUtils.getMimeType(rPath);
        if (!TextUtils.isEmpty(mimetype) && mimetype.toLowerCase().startsWith("image/")) {
            return true;
        }
        return false;
    }
