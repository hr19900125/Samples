...
public class AnimationExampleFragment extends BaseExampleFragment {
    ...
    protected void handleClick(int position) {
        ...
        switch (position) {
            ...
            case 12:
                intent = new Intent();
                intent.setClass(getActivity(), ObjectAnimatorExample1Activity.class);
                break;
            case 13:
                intent = new Intent();
                intent.setClass(getActivity(), ObjectAnimatorExample2Activity.class);
                break;
            case 14:
                intent = new Intent();
                intent.setClass(getActivity(), ObjectAnimatorExample3Activity.class);
                break;
            case 15:
                intent = new Intent();
                intent.setClass(getActivity(), PropertyValuesHolderExampleActivity.class);
                break;
            case 16:
                intent = new Intent();
                intent.setClass(getActivity(), AnimatorSetExampleActivity.class);
                break;
            case 17:
                intent = new Intent();
            ...
            case 19:
                intent = new Intent();
                intent.setClass(getActivity(), LayoutAnimationExample2Activity.class);
                break;
        }
        if (intent != null) {
