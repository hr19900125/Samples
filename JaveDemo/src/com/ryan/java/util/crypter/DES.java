...
public class DES
{
  ...
  private static void bitToByte(byte[] abyte0, byte[] abyte1, int i)
  {
    ...
    for (int k = 0; k < i; k++) {
      int tmp22_21 = (k >> 3);abyte0[tmp22_21] = ((byte)(abyte0[tmp22_21] | abyte1[k] << (k & 0x7)));
    }
  }
  ...
  {
    Arrays.fill(this.deskey, 0, 16, (byte)0);
  ...
  private byte[] doEncrypt(byte[] abyte0)
    throws Exception
  {
    byte[] abyte1 = usingDES(abyte0, this.key, (byte)1);
    return abyte1;
  }
  ...
  private byte[] doDecrypt(byte[] abyte0)
    throws Exception
  {
    byte[] abyte1 = usingDES(abyte0, this.key, (byte)2);
    return abyte1;
  }
